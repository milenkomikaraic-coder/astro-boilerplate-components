...
const Newsletter = (props) => (jsxRuntime.jsxs("div", { className: "flex flex-col items-center justify-between gap-6 sm:flex-row", children: [jsxRuntime.jsxs("div", { className: "sm:w-7/12", children: [jsxRuntime.jsx("div", { className: "text-3xl font-bold", children: props.title }), jsxRuntime.jsx("p", { className: "mt-3 text-gray-300", children: props.description })] }), jsxRuntime.jsx("div", { className: "w-full sm:w-5/12", children: jsxRuntime.jsxs("form", { className: "flex rounded-full bg-slate-800 px-4 py-2\n                   focus-within:ring-2 focus-within:ring-cyan-600\n                   hover:ring-2 hover:ring-cyan-600", children: [jsxRuntime.jsx("label", { htmlFor: "newsletter-email", className: "sr-only", children: "Email address" }), jsxRuntime.jsx("input", { id: "newsletter-email", type: "email", name: "email", autoComplete: "email", required: true, placeholder: "Your email", className: "w-full appearance-none bg-slate-800\n                     focus:outline-none text-white placeholder-gray-400" }), jsxRuntime.jsx("button", { type: "submit", className: "ml-2 shrink-0 rounded-full\n                     bg-gradient-to-br from-sky-500 to-cyan-400\n                     px-3 py-1 text-sm font-medium\n                     hover:from-sky-700 hover:to-cyan-600\n                     focus:outline-none focus:ring-2 focus:ring-cyan-600/50", children: "Subscribe" })] }) })] }));
